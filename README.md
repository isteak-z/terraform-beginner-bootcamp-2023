...
A Shebang (prounced Sha-bang) tells the bash script what program that will interpet the script. e.g. `#!/bin/bash`
...
```json
{
    "UserId": "GAZFOPSDMGSRGRTH59526",
    "Account": "987654321012",
    "Arn": "arn:aws:iam::987654321012:user/terraform-beginner-bootcamp"
}
```
